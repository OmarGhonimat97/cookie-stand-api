...
class CookieStandTests(APITestCase):
    ...
    def test_cookie_stands_model(self):
        ...
        self.assertEqual(actual_location, "SafeWay")
        self.assertEqual(actual_description, "Oreo Cookies")
    ...
    def test_get_cookie_stands_list(self):
        ...
        self.assertEqual(cookie_stands[0]["location"], "SafeWay")
    ...
    def test_get_cookie_stand_by_id(self):
        ...
        self.assertEqual(cookie_stand["location"], "SafeWay")

    def test_create_cookie_stand(self):
        url = reverse("cookie_stand_list")
        data = {"owner": 1, "location": "SafeWay", "description": "oreo"}
        response = self.client.post(url, data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        cookie_stands = CookieStand.objects.all()
        self.assertEqual(len(cookie_stands), 2)
        self.assertEqual(CookieStand.objects.get(id=2).location, "SafeWay")
